...
(define-key evil-normal-state-map (kbd "<backspace> <backspace> [") '+workspace/switch-left)
(define-key evil-normal-state-map (kbd "<backspace> <backspace> ]") '+workspace/switch-right)
(define-key evil-normal-state-map (kbd "<backspace> <backspace> d") '+workspace/delete)
(define-key evil-normal-state-map (kbd "<backspace> <backspace> l") '+workspace/load)
...
(define-key evil-normal-state-map (kbd ", , [") '+workspace/switch-left)
(define-key evil-normal-state-map (kbd ", , ]") '+workspace/switch-right)
(define-key evil-normal-state-map (kbd ", , d") '+workspace/delete)
(define-key evil-normal-state-map (kbd ", , l") '+workspace/load)
